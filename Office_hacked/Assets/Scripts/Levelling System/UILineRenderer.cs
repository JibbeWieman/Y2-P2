...
{
    public Vector2[] points = new Vector2[0]; // Initialise points to avoid null reference
    ...
    protected override void OnPopulateMesh(VertexHelper vh)
    {
        ...
        if (points == null || points.Length < 2) // Check for null or fewer than two points
            return;
    ...
    /// <param name="point2">The end point of the segment</param>
